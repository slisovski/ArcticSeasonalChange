...
drive         <-"/Users/tasos/Downloads/rasters/2018/"
...
#save(modisArray, file = "Output/modisArray.rda")
#writeRaster(ndvi, "ndvi.tif")
#writeRaster(ndsi, "ndsi.tif")
```

Afterwards, the array needs to be converted into a dataframe in order to be able to plot it. For better plotting, the NDSI values were converted to match the scale of NDVI values.


````{r, eval = T, collapse = TRUE}

load("/Users/tasos/Documents/modisArray.rda")
